...
def main() -> None:
    ...
    result_a = evaluate_replay(
        OfficialKeywordAgent(catalog_path), samples, categories, products
    )
    report_a = _report(
    ...
    print(
        ...
        f"score={result_a['recommended_technical_score']:.6f}",
        flush=True,
    )
    ...
    started = time.perf_counter()
    result_b = evaluate_replay(
        build_suite_agent(state_config, catalog_path), samples, categories, products
    )
    report_b = _report(
        ...
        provenance={
            ...
            "native_config": args.state_config,
    ...
    print(
        ...
        f"score={result_b['recommended_technical_score']:.6f}",
        flush=True,
    )
