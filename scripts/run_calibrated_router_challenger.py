...
def main() -> None:
    parser = argparse.ArgumentParser(description="Evaluate a calibrated route asset")
    parser.add_argument("--asset", type=Path, required=True)
    parser.add_argument("--limit", type=int, default=150)
    parser.add_argument(
        "--output", type=Path, default=Path("artifacts/reports/w2_router_v1.json")
    )
    ...
    agent = ExperimentalAgent(
        ...
        calibrated_router=CalibratedRouteModel.from_path(args.asset),
